...
<aside id="sidebar"
   ...
   {{ request()->routeIs('therapist.dashboard') ? $activeClass : $inactiveClass }}">

            @if(request()->routeIs('therapist.dashboard'))
                <span class="absolute left-0 top-1/2 -translate-y-1/2
                     w-1 h-6 bg-white rounded-r"></span>
            @endif

            <i class="fa-solid fa-gauge min-w-[20px] text-[20px]
       {{ request()->routeIs('therapist.dashboard') ? 'text-white' : 'text-[#F79C23]' }}">
            </i>
