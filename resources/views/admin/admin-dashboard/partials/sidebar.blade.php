<aside id="sidebar"
    ...
    <nav class="flex-1 px-4 py-6 space-y-6 text-sm">
        ...
        <span class="absolute left-0 top-1/2 -translate-y-1/2
            ...
            <i class="fa-solid fa-gauge min-w-[20px]"></i>
        ...
        <div class="space-y-1">
            ...
            <a href="#"
               class="flex items-center gap-3 px-4 py-3 rounded-xl
                ...
                <i class="fa-solid fa-users text-[#F79C23] text-[20px] min-w-[20px]"></i>
                <span class="ml-1 menu-text">Customers</span>
            </a>

            <a href="#"
               class="flex items-center gap-3 px-4 py-3 rounded-xl
                  text-gray-700 hover:bg-[#FFE2A8] transition">
                <i class="fa-solid fa-user-doctor text-[#F79C23] text-[20px] min-w-[20px]"></i>
                <span class="ml-2 menu-text">Therapists</span>
            </a>
            ...
            <a href="#"
               class="flex items-center gap-3 px-4 py-3 rounded-xl
                ...
                <span class="ml-1 menu-text">Admins</span>
            </a>
        </div>
