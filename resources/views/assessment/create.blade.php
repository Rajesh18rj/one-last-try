...
@section('content')
        ...
        <div class="relative max-w-6xl w-full px-0">
            <div class="bg-white/95 backdrop-blur-xl pb-6 pt-6 border border-amber-100/80
                ...
                @php
                    ...
                    /* =========================================================
                     |  ASSESSMENT SECTIONS – 8 TOPICS, 5 QUESTIONS EACH
                     |=========================================================*/
                    $sections = [
    ...
    {{-- Tab + auto-next logic --}}
    <script src="{{ asset('js/assessment/assessment-feedback.js') }}"></script>
    <script src="{{ asset('js/assessment/assessment.js') }}"></script>
    ...
    -->
    @push('styles')
        <link rel="stylesheet" href="{{ asset('css/assessment/create.css') }}">
    @endpush
